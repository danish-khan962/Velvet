...
const Hero = () => {
    return (
        <div className="mt-[35px] md:mt-[75px] px-4 md:px-20 flex flex-col md:flex-row justify-between items-center gap-10">
            <div className={`${raleway400.className}`}>
                ...
                <div className="flex flex-col gap-y-3 mt-[30px] md:mt-[35px]">
                    {heroBenefits.map((benefit, index) => (
                        <div className="flex flex-row items-center gap-x-5 font-semibold text-base md:text-[18px]" key={index}>
                            <MdOutlineDone className="text-green-500 text-[18px] md:text-[20px]" />
                            <p> {benefit} </p>
                        </div>
                    ))}
                </div>
                ...
                <div className='mt-[50px] md:mt-[60px] flex flex-row items-center gap-x-14 md:gap-x-18 justify-center md:justify-start'>
                    ...
                    <div className='flex flex-col gap-y-3'>
                        ...
                        <p className='text-sm md:text-base'> <span className='font-medium'>1,350+</span> happy clients</p>
                    </div>
                </div>
            </div>
